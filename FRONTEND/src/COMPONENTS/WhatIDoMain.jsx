      ...
      <div className="relative z-20 flex flex-col items-center justify-start min-h-screen px-4 sm:px-6 lg:px-8 py-20 text-white">
        ...
        <div className="max-w-4xl mx-auto text-center mb-12">
          ...
          <p className="text-base sm:text-lg md:text-xl leading-relaxed drop-shadow-md max-w-3xl mx-auto">
            Welcome to the Awuor Visions Atelier - a space where fashion meets authentic self-expression. 
            Each garment tells a story, each style celebrates the richness of being undeniably you while bridging the gap between urban aesthetic and traditional customs
          </p>
        </div>
        ...
        <div className="max-w-2xl mx-auto text-center mb-16 p-6 bg-black/30 backdrop-blur-sm rounded-lg">
          <p className="text-sm sm:text-base italic leading-relaxed">
            ...
            Here, we don't just dress people — we curate identities. 
            Every stitch, every fabric choice speaks to the soul of the wearer. 
            These are the stories of those who dared to wear their truth."
          </p>
          ...
          {fashionModels.map((card, index) => (
            ...
            >
              ...
              <div className="relative h-64 overflow-hidden">
                ...
                <div className={`absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent flex items-end p-4 transition-opacity duration-300 ${hoveredCard === card.id ? 'opacity-100' : 'opacity-0'}`}>
                  <p className="text-amber-400 font-bold text-sm">{card.style}</p>
                </div>
              </div>
              ...
              <div className="p-4">
                ...
                <p className="text-xs text-amber-300 uppercase tracking-wider mb-2">{card.style}</p>
        ...
        <div className="text-center mt-16 max-w-2xl mx-auto">
          <p className="text-sm sm:text-base text-white/90 italic">
            "Wealth means living out loud. Design a statement as vivid as your spirit."
          </p>
