...
/>
        ...
        <p className="text-sm sm:text-base md:text-lg lg:text-xl max-w-2xl mx-auto leading-relaxed drop-shadow-md font-semibold">
          <span className='text-amber-500'>Feel</span> The <span className='text-amber-500'>Buzz</span> With Our <span className='text-amber-500'>Designs</span>
          <br className="hidden sm:block" />
          Experience the story encrypted within our our aesthetics and varieties
        </p>
      </div>
    </section>
  );
